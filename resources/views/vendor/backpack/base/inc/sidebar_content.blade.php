...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('dashboard') }}'><i class='la la-dashboard nav-icon'></i> Dashboard</a></li>
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('guardian') }}"><i class="nav-icon la la-users"></i> Parents</a></li>
